    ...
    <div className=" w-full mx-auto flex flex-col items-center">
      <div className="">
        ...
        <div className="bg-gradient-to-r from-gray-900 to-gray-800 p-2 rounded-t-2xl mb-[15px]">
          <h2 className="text-[18px] font-bold text-white text-center">Imagen</h2>
          <p className="text-gray-300 text-center mt-1 text-[15px]">Agrega una imagen en el recuadro de abajo</p>
        </div>
